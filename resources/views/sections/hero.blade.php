    ...
    <div class="row gy-4 align-items-center">
      <div class="col-lg-6 order-2 order-lg-1">
        <div class="hero-content">
          <h1 data-aos="fade-up" data-aos-delay="200">Hello, I'm <span class="highlight">Brendon Panlaqui</span></h1>
          ...
          <p data-aos="fade-up" data-aos-delay="400">I’m passionate about creating responsive, user-friendly software, and turning ideas into functional digital experiences. With a growing foundation in technologies, I’m constantly learning and exploring new tools to build modern, meaningful solutions.</p>
      ...
      <div class="col-lg-6 order-1 order-lg-2">
        <div class="hero-image" data-aos="zoom-in" data-aos-delay="300">
          <div class="image-wrapper">
            <img src="assets/img/profile/profile-side.jpg" alt="Brendon L. Panlaqui" class="img-fluid">
